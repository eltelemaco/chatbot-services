/*
 * Barber & Co. — floating chat widget.
 * Self-contained so it can be dropped onto any page with one <script> tag.
 * Styles and DOM are injected at runtime to avoid CSS-name collisions.
 */
(function (global) {
  "use strict";

  const SESSION_KEY = "cornercuts_session";

  // Defaults mirror the landing-page nginx proxy setup.
  const defaults = {
    apiEndpoint: "/api/chat",
    healthEndpoint: "/api/health",
    brandName: "Corner Cutters",
    welcomeMessage:
      "¡Bienvenido a Corner Cutters en Guadalajara! Soy la recepción virtual. ¿Qué te gustaría agendar?",
    timeoutMs: 90000,
  };
